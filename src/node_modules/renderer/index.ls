...
# ------------------------------------------------------------------ Description
	...
	desc:
		short: '''The base class for all renderers.'''
...
# ---------------------------------------------------------------------- Methods
	...
	methods:
		...
		render-section: (contents, level) ->
			...
			sections = for title, content of contents
				section = ''
		...
		emphase: (text, options) ->
			...
			i = dop.extractProperty options, {
				names: <[i italic oblique]>
				type: oop.types.Boolean
			}
			b = dop.extractProperty options, {
				names: <[b bold]>
				type: oop.types.Boolean
			}
